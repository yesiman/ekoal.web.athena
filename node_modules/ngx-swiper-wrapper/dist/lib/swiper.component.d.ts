import { NgZone, ElementRef, AfterViewInit, OnDestroy, EventEmitter } from '@angular/core';
...
export declare class SwiperComponent implements AfterViewInit, OnDestroy {
    ...
    constructor(zone: NgZone, platformId: Object, defaults: SwiperConfigInterface);
