(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/operators'), require('tslib'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@ngxs/store', ['exports', '@angular/core', 'rxjs/operators', 'tslib', 'rxjs'], factory) :
    (factory((global.ngxs = global.ngxs || {}, global.ngxs.store = {}),global.ng.core,global.Rx.Observable.prototype,global.tslib,global.rxjs));
}(this, (function (exports,core,operators,tslib,rxjs) { 'use strict';
        ...
        return function (target, key, descriptor) {
            ...
            if (descriptor.value !== null) {
                ...
                var wrappedFn = function wrappedSelectorFn() {
                    ...
                    var returnValue = prev_1.apply(void 0, tslib.__spread(args));
                ...
                var fn = function (state) {
                    ...
                    if (selectors) {
                        results.push.apply(results, tslib.__spread(selectors.map(function (a) { return getSelectorFn(a)(state); })));
                    }
                    // if the lambda tries to access a something on the
                    // state that doesn't exist, it will throw a TypeError.
                    // since this is quite usual behaviour, we simply return undefined if so.
                    try {
                        return memoizedFn_1.apply(void 0, tslib.__spread(results));
                    }
                    catch (ex) {
