...
var NgsRevealDirective = (function (_super) {
    ...
    NgsRevealDirective.propDecorators = {
        ...
        '_config': [{ type: core.Input, args: ['ngsReveal',] },],
    };
...
var NgsRevealSetDirective = (function (_super) {
    ...
    NgsRevealSetDirective.propDecorators = {
        '_config': [{ type: core.Input, args: ['ngsRevealSet',] },],
        'ngsSelector': [{ type: core.Input },],
        'ngsInterval': [{ type: core.Input },],
        'ngsSync': [{ type: core.Input },],
    };
