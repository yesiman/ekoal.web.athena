...
var ngx_nvd3_core_1 = require("./ngx-nvd3.core");
var NvD3Directive = (function () {
    function NvD3Directive(el) {
        this.el = el;
        this.ngNvD3 = new ngx_nvd3_core_1.Angular2NvD3.NgNvD3(this.el);
    }
    NvD3Directive.prototype.ngOnChanges = function (changes) {
    ...
    NvD3Directive = __decorate([
        core_1.Directive({ selector: '[nvd3]' }),
