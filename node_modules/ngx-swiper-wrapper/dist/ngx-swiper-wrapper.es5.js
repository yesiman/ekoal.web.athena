import { InjectionToken, PLATFORM_ID, NgZone, Inject, Optional, ElementRef, Directive, Input, Output, EventEmitter, KeyValueDiffers, Component, ViewChild, ViewEncapsulation, NgModule } from '@angular/core';
    ...
    function () {
        ...
        SwiperEvents.forEach(function (eventName) {
            ...
            _this.instance.on(eventName, function () {
                ...
                if (_this["S_" + eventName.toUpperCase()].observers.length > 0) {
                    _this.zone.run(function () {
...
var SwiperComponent = /** @class */ (function () {
    function SwiperComponent(zone, platformId, defaults) {
        this.zone = zone;
        this.platformId = platformId;
        this.defaults = defaults;
        this.index = null;
